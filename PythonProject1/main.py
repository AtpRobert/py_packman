...
player_images = []
for i in range(1, 2):
    player_images.append(pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Pac-man1.png"), (45, 45)))
    player_images.append(pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Pac-man2.png"),(45,45)))
blinky_img = pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Red-Ghost.png"), (45, 45))
pinky_img = pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Purple-Ghost.png"), (45, 45))
inky_img = pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Blue-Ghost.png"), (45, 45))
clyde_img = pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Yellow-Ghost.png"), (45, 45))
spooked_img = pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Scared ghost.png"), (45, 45))
dead_img = pygame.transform.scale(pygame.image.load(r"C:\Users\ROBERT\Pictures\Pac-man game assests\photos\Dead-Ghost.png"), (45, 45))
player_x = 450
player_y = 663
direction = 0
blinky_x = 410
...
def draw_player():
    ...
    # Alternate the images every 0.25 seconds (4 frames)
    frames=10
    if direction == 0:  # Pac-Man facing right
        if counter // frames % 2 == 0:
            screen.blit(player_images[0], (player_x, player_y))  # Pac-Man 1 (Normal)
        else:
            screen.blit(player_images[1], (player_x, player_y))  # Pac-Man 2 (Flickering)
    elif direction == 1:  # Pac-Man facing left
        if counter // frames % 2 == 0:
    ...
    elif direction == 2:  # Pac-Man facing up
        if counter // frames % 2 == 0:
    ...
    elif direction == 3:  # Pac-Man facing down
        if counter // frames % 2 == 0:
